...
function websdkready() {
  ...
  var SDK_KEY = "lP38zJujdpI2vHIInKzvKKXhXMSSBJlWPJWb";
  /**
   ...
   */
  var SDK_SECRET = "FtHuH16YT8QsqsB9ibeJL8x14xpUTsWVmCbX";
  ...
  document
    ...
    .addEventListener("input", function (e) {
      ...
      console.log("미팅tmpMn : ",tmpMn);
      console.log("미팅Pwd : ",tmpPwd);
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "/zoom/openZoom";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/zoom/openZoom2?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
